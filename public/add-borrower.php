                            ...
                            <form action="" class="form-horizontal" method="post" id="add_borrower_form" enctype="multipart/form-data">
                                ...
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div class="flex items-center space-x-4 mb-4 px-4">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="borrower_dob" class="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" id="inputBorrowerDob" placeholder="dd/mm/yyyy" value="">
                                        </div>
                                    </div>
                                    <div class="flex items-center space-x-4 mb-4 px-4">
